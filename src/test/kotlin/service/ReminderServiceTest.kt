...
class ReminderServiceTest : DatabaseTest() {
    ...
    fun testAddReminderInvalidTimeZone() {
        assertThrows<IllegalArgumentException> {
            reminderService.addReminder(NewReminder(null, "e1", ReminderType.ADHOC, "message", "100", "invalid"))
        }
    }

    @Test
    fun testAddReminderGivenIdDoesNotPerformUpdate() {
        val rem = reminderService.addReminder(NewReminder(null, "e1", ReminderType.ADHOC, "message", "100", tz))
        val res = reminderService.addReminder(NewReminder(rem.reminderId, "e1", ReminderType.RECURRING, "message", "200", tz))
    ...
    fun testAddReminderNoEntry() {
        ...
        assertThrows<SQLException> {
            reminderService.addReminder(NewReminder(null, "nothing", ReminderType.ADHOC, "message", "100", tz))
        }
    }

    @Test
    fun testGetAllReminders() {
        reminderService.add(reminder("sid", "e1", ReminderType.ADHOC, "message", 100))
        reminderService.add(reminder("sid2", "e1", ReminderType.RECURRING, "message", 200))
        reminderService.add(reminder("sid3", "e2", ReminderType.RECURRING, "message", 300))
    ...
    fun testUpdateReminderNoId() {
        val res = reminderService.updateReminder(NewReminder(null, "e1", ReminderType.ADHOC, "message", "300", tz))
    ...
    fun testUpdateReminder() {
        val res1 = reminderService.addReminder(NewReminder(null, "e1", ReminderType.ADHOC, "message", "100", tz))
        val res2 = reminderService.addReminder(NewReminder(null, "e1", ReminderType.RECURRING, "message", "200", tz))
        assertThat(reminderService.getAllReminders()).hasSize(2).extracting("reminderId").doesNotHaveDuplicates()

        val updated = reminderService.updateReminder(NewReminder(res1.reminderId, "e1", ReminderType.RECURRING, "message2", "500", tz))
        ...
        val updated2 = reminderService.updateReminder(NewReminder(res2.reminderId, "e2", ReminderType.ADHOC, "message3", "800", "America/New_York"))
    ...
    fun testUpdateReminderInvalidTimeZone() {
        val res1 = reminderService.addReminder(NewReminder(null, "e1", ReminderType.ADHOC, "message", "100", tz))
        assertThrows<IllegalArgumentException> {
            reminderService.updateReminder(NewReminder(res1.reminderId, "e1", ReminderType.RECURRING, "message", "500", "invalid"))
        }
    }
